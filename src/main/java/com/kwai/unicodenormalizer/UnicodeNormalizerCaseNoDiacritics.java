...
@Description(name = "unicode_normalizer_case_no_diacritics", value = "_FUNC_(s) - UDF that returns the normalized unicode string converted to lower case and remove diacritics")
public class UnicodeNormalizerCaseNoDiacritics extends UDF {
	/*
